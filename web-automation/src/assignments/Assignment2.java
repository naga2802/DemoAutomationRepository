...
public class Assignment2 {
	...
	private static void createuser()
	{
		try
		{
			...
			oBrowser.findElement(By.id("userDataLightBox_usernameField")).sendKeys("Naga");
	...
	private static void modifyuser()
	{
		try
		{
			...
			oBrowser.findElement(By.id("userDataLightBox_firstNameField")).click();
			oBrowser.findElement(By.id("userDataLightBox_firstNameField")).clear();
			Thread.sleep(3000);
			oBrowser.findElement(By.id("userDataLightBox_firstNameField")).sendKeys("ajay");
			Thread.sleep(3000);
