...
public class Assignment6 {
	...
	private static void custamerUser()
	{
		try
		{
			...
			Thread.sleep(4000);
			oBrowser.findElement(By.xpath("//*[@id=\"customerLightBox_nameField\"]")).sendKeys("pavan");
			Thread.sleep(2000);
	...
	private static void project()
	{
		try
		{
			...
			Thread.sleep(2000);
			oBrowser.findElement(By.id("projectPopup_projectNameField")).sendKeys("New project");
			Thread.sleep(2000);
