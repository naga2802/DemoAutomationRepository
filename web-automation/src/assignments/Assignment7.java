...
public class Assignment7 {
	...
	private static void custamerUser()
	{
		try
		{
			...
			Thread.sleep(2000);
			oBrowser.findElement(By.xpath("//*[@id=\"customerLightBox_nameField\"]")).sendKeys("Red");
			Thread.sleep(2000);
	...
	private static void project()
	{
		try
		{
			...
			Thread.sleep(2000);
			oBrowser.findElement(By.id("projectPopup_projectNameField")).sendKeys("Clock project");
			Thread.sleep(2000);
	...
	private static void createtask()
	{
		try
		{
			...
			Thread.sleep(2000);
			oBrowser.findElement(By.xpath("//*[@id='createTasksPopup_createTasksTableContainer']/table/tbody/tr[1]/td[1]/input")).sendKeys("Testing1");
			Thread.sleep(2000);
	...
	private static void deleteTesting()
	{
		try
		{
			...
			Thread.sleep(2000);
			oBrowser.findElement(By.xpath("oBrowser.findElement(By.xpath")).click();
			Thread.sleep(2000);
