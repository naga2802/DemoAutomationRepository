...
public class AdvanceScenario2
{
	...
	static void createUser()
	{
		try
		{
			...
			oPage.getCreateUserEmail().sendKeys("nograj@gmail.com");
			Thread.sleep(2000);
	...
	static void createUser2()
	{
		try
		{
			...
			oPage.getCreateUserLastName().sendKeys("maddi2");
			oPage.getCreateUserEmail().sendKeys("AjayMaddi2@gmail.com");
			Thread.sleep(2000);
	...
	static void createUser3()
	{
		try
		{
			...
			oPage.getCreateUserLastName().sendKeys("maddi3");
			oPage.getCreateUserEmail().sendKeys("ajayMaddi3@gmail.com");
			Thread.sleep(2000);
